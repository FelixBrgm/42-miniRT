...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/11/21 00:26:48 by fbruggem          #+#    #+#             */
/*   Updated: 2022/11/21 00:27:43 by fbruggem         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_ray	ray_calculate(t_calculate cal_obj, int x, int y)
{
	...
	ray = ray_create(cal_obj.origin,
			vector_sub(vector_add(cal_obj.lower_left_corner,
					vector_add(vector_mul_n(cal_obj.horizontal, u),
