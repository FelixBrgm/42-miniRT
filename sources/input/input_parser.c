...
int parse_ambient(t_data *data, char *line)
{
	...
	data->scene.ambient.color.r = ft_atoi(color_split[0]) / 255;
	data->scene.ambient.color.g = ft_atoi(color_split[1]) / 255;
	data->scene.ambient.color.b = ft_atoi(color_split[2]) / 255;
	return (0);
}
// C -50,0,20 0,0,0 70
...
int parse_sphere(t_data *data, char *line, int *obj_i)
{
	...
	data->scene.objs[*obj_i]->sphere->color.r = ft_atoi(coords_split[0]) / 255;
	data->scene.objs[*obj_i]->sphere->color.g = ft_atoi(coords_split[1]) / 255;
	data->scene.objs[*obj_i]->sphere->color.b = ft_atoi(coords_split[2]) / 255;
	// free coords split;
...
int parse_plane(t_data *data, char *line, int *obj_i)
{
	...
	// free coords split;
	coords_split = ft_split(line_split[3], ',');
	data->scene.objs[*obj_i]->plane->color.r = ft_atoi(coords_split[0]) / 255;
	data->scene.objs[*obj_i]->plane->color.g = ft_atoi(coords_split[1]) / 255;
	data->scene.objs[*obj_i]->plane->color.b = ft_atoi(coords_split[2]) / 255;
	// free coords split;
